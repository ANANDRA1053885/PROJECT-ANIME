  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="relative">
        <div className="h-72" style={{ background: 'linear-gradient(135deg, rgba(34,197,94,0.2), rgba(255,107,157,0.1), black)' }} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <div className="w-36 h-52 rounded-xl flex items-center justify-center flex-shrink-0 text-5xl shadow-2xl border border-white/10"
                style={{ background: 'linear-gradient(135deg, rgba(34,197,94,0.3), rgba(255,107,157,0.1))' }}>
                ⚔️
              </div>
              <div className="flex-1">
                <div className="flex flex-wrap gap-2 mb-3">
                  {["Action", "Drama", "2013"].map((tag) => (
                ...
                <h1 className="text-4xl font-black text-white mb-2">Attack on Titan</h1>
                <p className="text-white/50 text-sm mb-4">進撃の巨人 • 87 Episodes • Finished</p>
                <div className="flex items-center gap-6 mb-6">
                  <div className="flex items-center gap-2">
                    <Star className="fill-yellow-400 text-yellow-400" size={20} />
                    <span className="text-2xl font-black text-white">9.8</span>
                    <span className="text-white/40 text-sm">/10</span>
                  </div>
                  <span className="text-white/20">|</span>
                  <span className="text-white/50 text-sm">210K ratings</span>
                  <span className="text-white/20">|</span>
                  <span className="text-white/50 text-sm">Ranked #1</span>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-10">
            <section>
              ...
              <p className="text-white/60 leading-relaxed">
                ...
                called Titans. Surviving humans built massive walls to protect themselves. Eren Yeager, whose
                mother was eaten by a Titan, vows to wipe out every Titan. He enlists in the Survey Corps —
                an elite military unit that combats Titans outside the walls. But the truth behind the Titans
                is far more complex and horrifying than anyone imagined.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                {[
                  { title: "Did the ending do justice to the series?", replies: 2341, votes: 8921, hot: true },
                  { title: "Eren's character arc — hero or villain?", replies: 1823, votes: 6234, hot: true },
                  { title: "The Rumbling — was it justified?", replies: 987, votes: 3421, hot: true },
                  { title: "Best AOT season ranked by community", replies: 445, votes: 1876, hot: false },
                ].map((thread, i) => (
          ...
          <div className="space-y-6">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: "Studio", value: "WIT / MAPPA" },
                  { label: "Season", value: "Spring 2013" },
                  { label: "Episodes", value: "87" },
