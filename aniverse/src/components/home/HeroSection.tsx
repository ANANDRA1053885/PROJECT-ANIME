...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(201,168,76,0.08) 0%, black 50%, black 100%)' }} />
      <div className="absolute top-20 right-20 w-96 h-96 rounded-full blur-3xl animate-pulse" style={{ backgroundColor: 'rgba(201,168,76,0.07)' }} />
      <div className="absolute bottom-20 left-20 w-64 h-64 rounded-full blur-3xl animate-pulse" style={{ backgroundColor: 'rgba(201,168,76,0.05)', animationDelay: '1s' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-3xl">
          <motion.div
            ...
            style={{ backgroundColor: 'rgba(201,168,76,0.08)', borderColor: 'rgba(201,168,76,0.2)', color: '#FFD700' }}
          >
          ...
          >
            <Link href="/anime"
              className="font-semibold px-8 py-4 rounded-full transition-all duration-200 hover:scale-105 hover:opacity-90 text-black"
          ...
          >
            {[
              ...
              <div key={stat.label}>
                <div className="text-3xl font-black" style={{ color: '#FFD700' }}>{stat.value}</div>
